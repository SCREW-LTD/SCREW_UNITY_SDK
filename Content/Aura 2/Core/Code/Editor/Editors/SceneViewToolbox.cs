...
namespace Aura2API
{
    ...
    public class SceneViewToolbox
    {
        ...
        private static void DrawActivationToggleButtonBody(int controlId)
        {
            ...
            GUIContent buttonContent = new GUIContent(EditorApplication.isCompiling ? "PLEASE WAIT" : ((AuraEditorPrefs.EnableAuraInSceneView ? "Disable" : "Enable") + " STARGAZER Lights"), Aura.ResourcesCollection.logoIconTexture);
        ...
        private static void DrawDisplayToggleButtonBody(int controlId)
        {
            ...
            string expansionToggleButtonString = IsExpanded ? "STARGAZER" : "STARGAZER";
